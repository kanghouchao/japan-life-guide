...
# 初回プッシュの場合（上流ブランチを設定）
git push -u origin feature/add-housing-page-#15
```
...
3. **プルリクエスト設定を確認**：
   ...
   - **Head repository**: `あなたのユーザー名/japan-life-guide` (compare: `feature/add-housing-page`) ← 自分のフォーク
4. **タイトルと説明を記入**：
